...
class Toplevel1:
    def __init__(self):
        ...
        self.Label3.place(relx=0.25, rely=0.95, height=16, width=214)
    ...
    def cadastro(self):
        ...
        self.Label1Usu = tk.Label(self.FrameCadastro)
        self.Label1Usu.place(relx=0.090, rely=0.142, height=29, width=140)
        self.Label1Usu.configure(background="#0a01a7")
        self.Label1Usu.configure(disabledforeground="#a3a3a3")
        self.Label1Usu.configure(foreground="#000000")
        self.Label1Usu.configure(font="-family {Segoe UI} -size 8 -weight bold")
        self.Label1Usu.configure(text='''''')
    ...
    def LoginBackEnd(self):
          ...
          for x in range(len(usuarios)):
              if usuario==usuarios[x] and senha==senhas[x]:
                ...
                self.cadastro()  
                self.Label1Usu["background"]="#C0C0C0"
                self.Label1Usu["text"]="USUÁRIO "+usuario+" LOGADO"
